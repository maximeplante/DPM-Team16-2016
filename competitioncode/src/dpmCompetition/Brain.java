...
public class Brain extends Thread {
    ...
    public void run() {
        ...
        startXcoord = startXcoord*Main.TILE_LENGTH;
        startYcoord = startYcoord*Main.TILE_LENGTH;
        startAng = startAng*90;
        odo.setPosition(new double [] {startXcoord, startYcoord, startAng}, new boolean [] {true, true, true});
