...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        competitionData.redZone.lowerLeft.x = 93;
        competitionData.redZone.lowerLeft.y = 93;
        competitionData.redZone.upperRight.x = 124;
        competitionData.redZone.upperRight.y = 124;
        competitionData.builderTeamNumber = 16;
        competitionData.builderStaringCorner = 1;
        competitionData.collectorTeamNumber = 1;
        competitionData.collectorStartingCorner = 2;
        ...
        */
        ...
        // Driver
        Driver driver = new Driver(odometer, navigation, competitionData, areaScanner, frontLsPoller, usPoller);
